...
def create_movie_session(movie_show_time: time, movie_id: int, cinema_hall_id: int) -> MovieSession:
...
def update_movie_session(session_id: int, show_time: time=None, movie_id: int=None, cinema_hall_id: int=None) -> None:
    data = {}
