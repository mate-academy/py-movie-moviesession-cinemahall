...
def update_movie_session(session_id: int,
    ...
    updating_movie = MovieSession.objects.get(id=session_id)
    if show_time:
        updating_movie.show_time = show_time
    if movie_id:
        updating_movie.movie_id = movie_id
    if cinema_hall_id:
        updating_movie.cinema_hall_id = cinema_hall_id
