...
def get_movies(genres_ids: Optional[List[int]] = None, actors_ids: Optional[List[int]] = None) -> QuerySet:
    """
    Retrieve movies based on optional filters: genres_ids and actors_ids.
    If both filters are provided, return movies that match at least one genre and one actor.
    ...
    if genres_ids and actors_ids:
        # Filter movies that have at least one genre from genres_ids and one actor from actors_ids
...
def create_movie(movie_title: str, movie_description: str, genres_ids: Optional[List[int]] = None,
                 actors_ids: Optional[List[int]] = None) -> Movie:
    """
    Create a movie with the provided title and description, and optionally add genres and actors.
