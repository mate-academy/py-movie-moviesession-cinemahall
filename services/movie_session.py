...
def update_movie_session(session_id: int,
    ...
    movie_session_to_upd = MovieSession.objects.filter(id=session_id)
    if show_time:
        movie_session_to_upd.update(show_time=show_time)
    if movie_id:
        movie_session_to_upd.update(movie_id=movie_id)
    if cinema_hall_id:
        movie_session_to_upd.update(cinema_hall_id=cinema_hall_id)
