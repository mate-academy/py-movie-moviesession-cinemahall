...
def get_movie_genre(genres_ids: int=None, actors_ids: int=None) -> QuerySet[Movie] | None:
...
def create_movie(movie_title: str, movie_description: str, genres_ids=None, actors_ids=None) -> Movie:
