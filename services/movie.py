...
def get_movies(genres_ids: list[int] = None, actors_ids: list[int] = None) -> "Query set":
...
def create_movie(movie_title: str, movie_description: str, genres_ids: list[int] = None, actors_ids: list[int] = None):
